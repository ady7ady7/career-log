...
2.12.25 (Day 47)
- Completed day2 from Dane są wszędzie Advent challenge - it wasn't very difficult, and I've also practiced LEFT JOIN in PBI using PowerQuery (clicked, not using any code in there tho) and it wasn't that difficult, especially that I understand the logic behind all of that -> anyway, it felt a lot more natural to implement everything and find the relevant answers using SQL in DBeaver